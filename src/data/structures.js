...
import { IoMdContacts, IoIosCar } from 'react-icons/io';
...
export const tableLocalization = {
  ...
  ungroupByColumn: 'בטל קיבוץ {column}',
  unpin: 'בטל הצמדה',
...
export const dateAlert = (props) => (
  <button
    type="button"
    disabled={true}
    style={{ background: (props.licenseDate === null ? "#C6C3C2" : props.licenseDateStatus) }}
    className="text-white py-1 px-2 capitalize rounded-2xl text-md" >
    {(props.licenseDate === null ? "נתון לא זמין":props.licenseDate)}
  </button>
);

export const insuranceHovaAlert = (props) => (
  <button
    type="button"
    disabled={true}
    style={{ background: (props.insuranceHova === null ? "#C6C3C2" : props.insuranceHovaStatus) }}
    className="text-white py-1 px-2 capitalize rounded-2xl text-md">
    {(props.insuranceHova === null ? "נתון לא זמין":props.insuranceHova)}
  </button>
);

export const insuranceSelishiAlert = (props) => (
  <button
    type="button"
    disabled={true}
    style={{ background: (props.insuranceSelishi === null ? "#C6C3C2" : props.insuranceSelishiStatus) }}
    className="text-white py-1 px-2 capitalize rounded-2xl text-md" >
    {(props.insuranceSelishi === null ? "נתון לא זמין":props.insuranceSelishi)}
  </button>
);

export const kmNextTipulAlert = (props) => (
  <button
    type="button"
    disabled={true}
    style={{ background: (props.licenseDate === null ? "#C6C3C2" : props.kmNextTipulStatus) }}
    className="text-white py-1 px-2 capitalize rounded-2xl text-md" >
    {(props.kmNextTipul === null ? "נתון לא זמין":props.kmNextTipul)}
  </button>
);

export const licenseExpireDateAlert = (props) => (
  <button
    type="button"
    disabled={true}
    style={{ background: (props.licenseExpireDate === null ? "#C6C3C2" : props.licenseExpireDateStatus) }}
    className="text-white py-1 px-2 capitalize rounded-2xl text-md" >
    {(props.licenseExpireDate === null ? "נתון לא זמין":props.licenseExpireDate)}
  </button>
);

export const trainingDateAlert = (props) => (
  <button
    type="button"
    disabled={true}
    style={{ background: (props.trainingDate === null ? "#C6C3C2" : props.trainingDateStatus) }}
    className="text-white py-1 px-2 capitalize rounded-2xl text-md" >
    {(props.trainingDate === null ? "נתון לא זמין":props.trainingDate)}
  </button>
);
...
export const gridStatusProfile = (props) => (
  <button
    type="button"
    onClick={() => {}}
    className="text-white py-1 px-2 capitalize rounded-2xl text-md">
    {<img
      ...
      src={(props.status === 'alarm') ? alarm : (props.status === 'warn') ? warn : ok}
      alt={''}
    />}
  </button>
  );
  ...
  export const driverEdit = (props) => (
    <Button
      color="primary"
      onClick={() => { openInPopup(props.data.name) }}
      >
      <EditOutlinedIcon fontSize="small" />
    </Button>
  );
...
export const carGrid = [
  ...
  { 
    field: 'kmNextTipul',
	  headerText: 'ק"\מ טיפול הבא',
    width: '40',
    textAlign: 'Center',
    template: kmNextTipulAlert,
  },
  { 
    field: 'toolType',
    headerText: 'סוג הכלי',
  ...
  { 
    field: 'insuranceHova',
    headerText: 'ביטוח חובה',
    width: '30',
    textAlign: 'Center',

    template: insuranceHovaAlert,
  },
  { 
    field: 'insuranceSelishi',
    headerText: 'ביטוח צד ג',
    width: '30',
    textAlign: 'Center',

    template: insuranceSelishiAlert,
  }
];
...
export const driverGrid = [
  ...
  { field: 'licenseExpireDate',
    ...
    width: '30',
    textAlign: 'Center',
    template: licenseExpireDateAlert,
  },
  { field: 'training',
    headerText: 'הדרכה',
    width: '30',
  ...
  { field: 'trainingDate',
    headerText: 'תאריך הדרכה',
    width: '40',
    textAlign: 'Center',
    template: trainingDateAlert,
  },
  { field: 'city',
    headerText: 'עיר',
    width: '30',
